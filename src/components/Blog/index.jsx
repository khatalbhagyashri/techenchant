      ...
      >
        <div className="w-full flex flex-col items-center  bg-red-00">
          ...
          <p className="mt-3 font-normal text-textColor text-base">
            Stay updated with expert tips and trends in digital marketing and
            web strategies.
          </p>
        </div>
        ...
        <div className="w-full grid bg-red-00 grid-cols-1 md:grid-cols-3 gap-5">
          {visiblePosts.map((post) => (
            ...
            >
              ...
              />
              <div
                className="absolute inset-0 bg-black bg-opacity-60 p-4 transform translate-y-full group-hover:translate-y-0 
