...
function Services() {
  return (
    <div className="bg-red-200 md:px-28 px-6 py-20">
      ...
      <div className="md:w-3/4 mx-auto flex flex-wrap bg-red-00 mt-3 justify-around">
        {services.map((item) => (
          <div
            key={item.id}
            className="w-72 h-80 flex flex-col justify-between p-4 mt-4 bg-green-600 hover:bg-green-700 rounded-2xl"
          >
